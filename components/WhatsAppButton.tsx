...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="group fixed bottom-5 right-5 z-50 flex items-center rounded-full bg-[#25D366] text-white shadow-lg transition-all hover:shadow-xl md:bottom-8 md:right-8"
    >
